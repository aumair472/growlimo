...
export default function BlogPost({ source, frontMatter, slug }) {
  ...
  // ✅ FIX: Absolute image URL, correct author type, mainEntityOfPage added
  const blogPostingSchema = {
    ...
    image: frontMatter.featuredImage
      ? `${WWW}${frontMatter.featuredImage}`
      : `${WWW}/og-image.png`,
    datePublished: frontMatter.date,
    dateModified: frontMatter.date,
    // ✅ FIX: "GrowLimo Team" is an org, not a Person
    author: {
      '@type': 'Organization',
      name: 'GrowLimo',
      url: WWW,
...
export async function getStaticProps({ params }) {
  ...
  return {
    props: { source: mdxSource, frontMatter: data, slug },
  };
}
