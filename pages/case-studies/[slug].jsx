...
export default function CaseStudyDetail({ caseStudy, slug }) {
  ...
  // ✅ FIX: Add Article + BreadcrumbList schema
  const articleSchema = {
    '@type': 'Article',
    '@id': pageUrl,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              {/* ✅ FIX: next/image instead of raw <img> */}
              <div className="md:col-span-2 rounded-2xl overflow-hidden aspect-video relative">
                <Image
                  src={caseStudy.image}
                  alt={caseStudy.title}
                  fill
              ...
              <div className="glass-card p-8">
                <h2 className="text-xl font-bold text-white mb-6">{caseStudy.metricsBox.title}</h2>
            ...
            <div className="mt-20 text-center">
              ...
              <Link
                ...
                className="btn-primary inline-block px-12 py-5 rounded-xl font-bold text-xl"
              >
                {caseStudy.cta.text} →
              </Link>
            </div>
