...
export default function HSPageHero({ h1, subheadline, slug }) {
  const statBar = [
    { value: '287%', label: 'Avg. Patient Lead Increase', icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' },
    ...
    { value: 'YMYL/E-E-A-T', label: 'Compliant Strategy', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
    { value: 'HIPAA-Aware', label: 'Data Handling', icon: 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            <div className="inline-flex items-center gap-2 bg-[rgba(66,133,244,0.10)] border border-[rgba(66,133,244,0.25)] text-[#4285F4] text-[11px] md:text-[12px] font-extrabold uppercase tracking-[2.5px] rounded-full py-[6px] px-[16px] mb-6 leading-none font-sans">
              ...
              SPECIALIST HEALTHCARE & MEDICAL SEO AGENCY
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5 w-full mb-6">
              {statBar.map((stat, idx) => (
                ...
                >
                  <span className="text-[#00C68A] font-sora font-extrabold text-[15px] mb-0.5 leading-none">
                    {stat.value}
                  </span>
                  <span className="text-[#F0F4FF] font-sans text-[10.5px] font-medium leading-snug">
                    {stat.label}
                  </span>
                </div>
              ))}
          ...
          <div className="lg:col-span-5 w-full">
            <div className="bg-[#1A2438]/90 backdrop-blur-md border border-[rgba(255,255,255,0.08)] rounded-[20px] p-6 shadow-2xl relative text-left">
              ...
              <p className="text-[13px] text-[#8FA8C8] mb-4">
                Evaluate technical health, YMYL/E-E-A-T score, & local map pack rankings.
              </p>
              <Form
                slug={slug}
                compact={true}
