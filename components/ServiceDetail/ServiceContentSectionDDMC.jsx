...
export default function ServiceContentSectionDDMC({ service, slug, onSelectPlan }) {
  ...
  const {
    ...
    processSection = {},
    ctaSection = {},
    ctaButtonText = 'Get Your Free Dental Marketing Audit →',
    faqs = [],
    internalLinks = [],
    images = [],
    schema
  ...
  const whyDentalHarderSec = contentSections[0] || {};
  const whyIntegratedSec = contentSections[1] || {};
  const servicesIntroSec = contentSections[2] || {};
  
  // Numbered Services 1-9 are contentSections[3] to [11]
  const numberedServices = contentSections.slice(3, 12);

  // Case Studies Intro (index 12) & Individual Case Studies (indices 13, 14, 15)
  const caseStudiesIntroSec = contentSections[12] || {};
  const caseStudy1 = parseCaseStudy(contentSections[13]);
  const caseStudy2 = parseCaseStudy(contentSections[14]);
  const caseStudy3 = parseCaseStudy(contentSections[15]);
  const caseStudies = [caseStudy1, caseStudy2, caseStudy3].filter(Boolean);

  // Specialties (index 16), Cities (index 17), Partner/Author (index 18), Testimonials (index 19)
  const specialtiesSec = contentSections[16] || {};
  const citiesSec = contentSections[17] || {};
  const partnerSec = contentSections[18] || {};
  const testimonialsSec = contentSections[19] || {};
    ...
    <div className="bg-[#080D18] font-sans selection:bg-[#00C68A]/30 selection:text-white overflow-x-hidden text-[#8FA8C8]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col items-start text-left">
              <span className="bg-[rgba(0,198,138,0.08)] border border-[rgba(0,198,138,0.20)] text-[#00C68A] text-[11px] font-extrabold uppercase tracking-[2.5px] rounded-full py-[6px] px-[16px] mb-6 inline-flex font-sans leading-none">
                CALIFORNIA DENTIST MARKETING AGENCY
              </span>
              ...
              <div className="flex flex-wrap gap-3 mb-4 w-full">
                {[
                  { value: '60+ CA', label: 'Practice Partnerships' },
                  { value: '298%', label: 'Average Practice Growth' },
                  { value: '4.7x', label: 'Patient Acquisition ROI' }
                ].map((pill, idx) => (
                  <div
                    key={idx}
      ...
      <section className="relative w-full overflow-hidden">
        <div className="relative w-full h-[480px]">
          <img
            src={heroImg}
            alt="GrowLimo California Dentist Digital Marketing"
          ...
          <div className="absolute inset-0 flex items-center justify-center z-20">
            <div className="container mx-auto px-4 max-w-[1200px]">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  { value: '60+', text: 'California Dental Practices & DSOs Partnered' },
                  { value: '298%', text: 'Average Multi-Channel Patient Pipeline Growth' },
                  { value: '4.7x', text: 'Documented Patient Acquisition ROI baseline' }
                ].map((card, idx) => (
                  <div
                    key={idx}
        ...
        <div className="container mx-auto px-4 md:px-10 max-w-[1200px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              {whyDentalHarderSec.paragraphs && whyDentalHarderSec.paragraphs.map((para, idx) => (
                <p key={idx} className="font-sans text-[15px] leading-[1.8] text-[#3D5A73]">
                  {para}
                </p>
              ))}

              {whyDentalHarderSec.closingText && (
            ...
            <div className="lg:col-span-5">
              <div className="bg-[#F8FAFC] border border-[#E3EEF7] rounded-[20px] p-8 shadow-sm">
                <h3 className="font-sora font-bold text-[18px] text-[#0B1829] mb-6 text-left border-b border-[#E3EEF7] pb-3">
                  California Dental Marketing Pain-Points
                </h3>
                <div className="space-y-5">
                  {whyDentalHarderSec.bullets && whyDentalHarderSec.bullets.map((bullet, idx) => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5">
              <div className="rounded-[20px] overflow-hidden shadow-xl border-4 border-white relative group">
                <img
                  src={strategyImg}
                  alt="GrowLimo Dental Strategy Planning"
      ...
      {numberedServices.map((serviceSec, sIdx) => {
        ...
        return (
          <div key={sIdx}>
            <section className={`${bgClass} py-[96px] relative z-10 text-left`}>
              <div className="container mx-auto px-4 md:px-10 max-w-[1200px]">
                <div className="max-w-[860px] mx-auto">
                  ...
                  {/* Service Specific Closing Quote Link */}
            ...
            {/* B. Full-width Reputation / Review dashboard after Service 5 (Dental Reputation Management, sIdx === 4) */}
            {sIdx === 4 && patientReviewsImg && (
              <section className="relative w-full py-16 bg-[#080D18] flex justify-center border-t border-[rgba(255,255,255,0.04)]">
                <div className="container max-w-[900px] px-4">
                  <div className="rounded-[20px] overflow-hidden shadow-2xl border border-[rgba(255,255,255,0.06)] relative group">
                    <img
          ...
          <section key={idx} className={`${bgClass} py-[96px] relative z-10 border-t border-[rgba(255,255,255,0.04)]`}>
            ...
            <div className="container mx-auto px-4 md:px-10 max-w-[1200px]">
              ...
              <div className="relative w-full h-[320px] md:h-[520px] lg:h-[580px] rounded-[24px] overflow-hidden shadow-2xl border border-[rgba(255,255,255,0.06)] mb-12 group">
                <img
                  src={cs.image || (idx === 0 ? '/images/services/la-dental-case-study.webp' : idx === 1 ? '/images/services/sd-cosmetic-case-study.webp' : '/images/services/sac-family-case-study.webp')}
                  alt={cleanTitle}
                ...
                <div className="flex flex-wrap items-center gap-8 md:gap-12">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[13px] font-semibold text-[#F0F4FF] font-sans">
                      {idx === 0 ? 'Los Angeles, California' : idx === 1 ? 'San Diego, California' : 'Sacramento, California'}
                    </span>
                  </div>
                  ...
                  <div className="flex flex-col border-t md:border-t-0 md:border-l border-[rgba(255,255,255,0.08)] pt-4 md:pt-0 md:pl-8">
                    ...
                    <span className="text-[13px] font-semibold text-[#F0F4FF] font-sans">
                      {idx === 0 ? 'General, Cosmetic & Implants' : idx === 1 ? 'Cosmetic Dentistry & Smile Makeovers' : 'Family & General Dentistry'}
                    </span>
                  </div>
                </div>
              </div>
