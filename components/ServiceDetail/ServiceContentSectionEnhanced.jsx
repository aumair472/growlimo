...
export default function ServiceContentSectionEnhanced({ service, slug, onSelectPlan }) {
  ...
  const heroImg = images[0] || '/images/services/hero-seo-california.webp';
  const strategyImg = images[1] || '/images/services/strategy-planning.webp';
  const keywordImg = images[2] || '/images/services/keyword-research.webp';
  const linkImg = images[3] || '/images/services/link-building.webp';
  const bannerImg = images[4] || '/images/services/california-results-banner.webp';
  ...
  return (
    <div className="bg-[#080D18] font-sans selection:bg-[#00C68A]/30 selection:text-white overflow-x-hidden text-[#8FA8C8]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col items-start text-left">
              ...
              <div className="flex flex-wrap gap-3 mb-4 w-full">
                {[
                  { value: '100+', label: 'Clients Ranked' },
                  { value: 'Page 1', label: 'Guaranteed Focus' },
                  { value: '60-90', label: 'Days Avg. Results' }
                ].map((pill, idx) => (
                  <div
                    key={idx}
          ...
          <div className="absolute inset-0 flex items-center justify-center z-20">
            <div className="container mx-auto px-4 max-w-[1100px]">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  { value: '100+', text: 'California Businesses Ranking on Page 1' },
                  { value: '60-90', text: 'Days Average Time to First Ranking Results' },
                  { value: '100%', text: 'Data-Driven, Custom-Built SEO & Full transparency' }
                ].map((card, idx) => (
                  <div
                    key={idx}
              ...
              <section className="relative w-full py-16 bg-[#080D18] flex justify-center">
                <div className="container max-w-[900px] px-4">
                  <div className="rounded-[20px] overflow-hidden shadow-2xl border border-[rgba(255,255,255,0.06)] relative group">
                    <img
                      src={keywordImg}
                      alt="California Keyword Research & Strategy"
              ...
              <section className="relative w-full py-16 bg-[#080D18] flex justify-center">
                <div className="container max-w-[900px] px-4">
                  <div className="rounded-[20px] overflow-hidden shadow-2xl border border-[rgba(255,255,255,0.06)] relative group">
                    <img
                      src={linkImg}
                      alt="California Domain Authority Growth"
                      className="w-full h-auto max-h-[480px] object-cover transition-transform duration-500 group-hover:scale-[1.02]"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent pointer-events-none" />
                    <div className="absolute bottom-5 left-6 right-6 text-left">
      ...
      {caseStudiesSection.bullets && caseStudiesSection.bullets.map((bullet, idx) => {
