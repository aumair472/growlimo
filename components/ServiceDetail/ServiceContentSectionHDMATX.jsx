...
export default function ServiceContentSectionHDMATX({ service, slug, onSelectPlan }) {
  ...
  const heroImg = images[0] || '/images/services/hero-healthcare-digital-marketing-agency-texas.webp';
  const strategyImg = images[1] || '/images/services/healthcare-digital-marketing-agency-texas-strategy.webp';
  const keywordImg = images[2] || '/images/services/healthcare-digital-marketing-agency-texas-results-1.webp';
  const linkImg = images[3] || '/images/services/healthcare-digital-marketing-agency-texas-results-2.webp';
  const bannerImg = images[4] || '/images/services/healthcare-digital-marketing-agency-texas-banner.webp';

  const areaServedName = service.areaServedName || service.areaServed?.name || 'Texas';
  const locationLabel = `${areaServedName.toUpperCase()} HEALTHCARE DIGITAL MARKETING SPECIALISTS`;
  ...
  const parseTrustBarItem = (item, idx) => {
    ...
    if (cleaned.toLowerCase().includes('4.6x') || cleaned.toLowerCase().includes('roi')) {
      return { value: '4.6x', label: 'Average ROI' };
    }
    if (cleaned.toLowerCase().includes('291%')) {
      return { value: '291%', label: 'New Patient Inquiry Growth' };
    }
    if (cleaned.toLowerCase().includes('hipaa')) {
      return { value: 'HIPAA', label: 'Aware Configurations' };
    }
    if (cleaned.toLowerCase().includes('ymyl') || cleaned.toLowerCase().includes('clinical')) {
  ...
  const heroTrustPills = trustItems.length >= 3
    ...
    : [
        { value: '4.6x', label: 'Average ROI' },
        { value: '291%', label: 'New Patient Inquiry Growth' },
        { value: 'HIPAA', label: 'Aware Configurations' },
      ];
  ...
  const overlayTrustCards = trustItems.length >= 3
    ...
    : [
        { value: '4.6x', text: 'Average Return on Digital Marketing Investment' },
        { value: '291%', text: 'Average New Patient Inquiry Growth' },
        { value: 'HIPAA-Aware', text: 'Configurations for Texas Healthcare' },
      ];
    ...
    <div className="bg-[#080D18] font-sans selection:bg-[#00C68A]/30 selection:text-white overflow-x-hidden text-[#8FA8C8]">
            ...
            <div className="lg:col-span-6 w-full">
              <div className="bg-[#1A2438]/80 backdrop-blur-md border border-[rgba(255,255,255,0.08)] rounded-[20px] p-3 shadow-2xl relative">
                ...
                <h3 className="font-sora font-bold text-[14px] text-[#F0F4FF] mb-2 text-left border-b border-[rgba(255,255,255,0.06)] pb-1">
                  Free Texas Healthcare Digital Marketing Audit
                </h3>
                <Form
                  slug={slug}
                  compact={true}
      ...
      <section className="relative w-full overflow-hidden">
        <div className="relative w-full h-[480px]">
          <img
            src={heroImg}
            alt="GrowLimo Healthcare Digital Marketing Agency Texas"
            ...
            <div className="lg:col-span-5">
              <div className="bg-[#F8FAFC] border border-[#E3EEF7] rounded-[20px] p-8 shadow-sm">
                <h3 className="font-sora font-bold text-[18px] text-[#0B1829] mb-6 text-left border-b border-[#E3EEF7] pb-3">
                  Why General Agencies Fail Texas Healthcare
                </h3>
              ...
              <section className="relative w-full py-16 bg-[#080D18] flex justify-center">
                <div className="container max-w-[900px] px-4">
                  <div className="rounded-[20px] overflow-hidden shadow-2xl border border-[rgba(255,255,255,0.06)] relative group">
                    <img
                      src={keywordImg}
                      alt="Texas Healthcare Digital Marketing Strategy"
              ...
              <section className="relative w-full py-16 bg-[#080D18] flex justify-center">
                <div className="container max-w-[900px] px-4">
                  <div className="rounded-[20px] overflow-hidden shadow-2xl border border-[rgba(255,255,255,0.06)] relative group">
                    <img
                      src={linkImg}
                      alt="Texas Multi-Location Healthcare Marketing"
                      className="w-full h-auto max-h-[480px] object-cover transition-transform duration-500 group-hover:scale-[1.02]"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent pointer-events-none" />
                    <div className="absolute bottom-5 left-6 right-6 text-left">
      ...
      <section className="bg-[#0C1220] pt-[120px] pb-[60px] relative z-10 border-t border-[rgba(255,255,255,0.04)]">
        <div className="container mx-auto px-4 md:px-10 max-w-[1200px] text-center">
          ...
          <h2 className="text-[28px] md:text-[36px] lg:text-[40px] font-extrabold font-sora text-white leading-tight mb-6 tracking-tight max-w-[900px] mx-auto">
            {caseStudiesSection.heading || 'Texas Healthcare Digital Marketing Case Studies'}
          </h2>
      ...
      <section className="relative w-full overflow-hidden">
        <div className="relative w-full h-[320px]">
          <img
            src={bannerImg}
            alt="GrowLimo Texas Healthcare Digital Marketing Results"
        ...
        <div className="container mx-auto px-4 md:px-10 max-w-[1100px]">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-[26px] md:text-[36px] font-extrabold font-sora leading-tight text-[#F0F4FF] tracking-tight">
              {pricingSection.heading || 'Texas Healthcare Digital Marketing Investment'}
            </h2>
