...
const SITE_URL = import.meta.env.VITE_SITE_URL || siteConfig.siteUrl;
    ...
    <>
      ...
      <StructuredData
        data={{
          ...
          '@type': 'ContactPage',
          name: 'Contact Growlimo - Digital Marketing Agency',
          description:
            'Get in touch with Growlimo for a free growth strategy session. Specialists in SEO, PPC, and business growth across the USA.',
      ...
      <div className="bg-dark text-white">
        ...
        {/* ── Why Healthcare Practices Choose Growlimo ── */}
        ...
        {/* ── Service Directory - New Internal Links ── */}
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    <li><Link to="/dentist-digital-marketing-agency-california/" className="text-slate-400 hover:text-white transition-colors">Dentist Agency CA</Link></li>
                    <li><Link to="/dentist-digital-marketing-agency-texas/" className="text-slate-400 hover:text-white transition-colors">Dentist Agency TX</Link></li>
                    <li><Link to="/dentist-seo-services-california/" className="text-slate-400 hover:text-white transition-colors">Dentist SEO CA</Link></li>
                  </ul>
                </div>
                <div>
                  <h3 className="text-primary font-bold text-sm mb-4 uppercase tracking-wider">Healthcare SEO</h3>
                  <ul className="space-y-2 text-sm">
                    <li><Link to="/healthcare-digital-marketing-agency-california/" className="text-slate-400 hover:text-white transition-colors">Healthcare Agency CA</Link></li>
                    <li><Link to="/healthcare-digital-marketing-agency-texas/" className="text-slate-400 hover:text-white transition-colors">Healthcare Agency TX</Link></li>
                    <li><Link to="/healthcare-seo-services-california/" className="text-slate-400 hover:text-white transition-colors">Healthcare SEO CA</Link></li>
                  </ul>
                </div>
                <div>
                  <h3 className="text-primary font-bold text-sm mb-4 uppercase tracking-wider">Ads Management</h3>
                  <ul className="space-y-2 text-sm">
                    <li><Link to="/google-ads-management-california/" className="text-slate-400 hover:text-white transition-colors">Google Ads CA</Link></li>
                    <li><Link to="/google-ads-management-texas/" className="text-slate-400 hover:text-white transition-colors">Google Ads TX</Link></li>
                    <li><Link to="/healthcare-google-ads-management-california/" className="text-slate-400 hover:text-white transition-colors">Medical Ads CA</Link></li>
                  </ul>
                </div>
                <div>
                  <h3 className="text-primary font-bold text-sm mb-4 uppercase tracking-wider">General SEO</h3>
                  <ul className="space-y-2 text-sm">
                    <li><Link to="/seo-services-california/" className="text-slate-400 hover:text-white transition-colors">SEO Services CA</Link></li>
                    <li><Link to="/seo-services-texas/" className="text-slate-400 hover:text-white transition-colors">SEO Services TX</Link></li>
                    <li><Link to="/case-studies/" className="text-slate-400 hover:text-white transition-colors">Success Stories</Link></li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
                <a
                  ...
                  className="bg-primary hover:bg-accent text-white font-semibold py-3 px-8 rounded-lg transition transform hover:scale-105"
                >
