...
function Hero({ h1Text }) {
  ...
  useEffect(() => {
    // CWV CLS: Delay animations until after LCP to prevent layout shifts
    // Use requestAnimationFrame to ensure first paint is stable
  ...
  return (
    ...
    >
      {/* Background gradient overlay — CWV: will-change for GPU compositing, no repaints */}
      <div className="absolute inset-0 z-0 overflow-hidden" aria-hidden="true">
        <div className="absolute inset-0 bg-gradient-to-br from-dark via-slate-900 to-dark">
          {/* CWV INP: Replaced animate-pulse with CSS-only will-change for cheaper GPU animation */}
      ...
      <div className="relative z-10 w-full">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-5xl mx-auto">
            {/* Badge — CWV CLS: Render visible immediately, animate only opacity (no translate = no CLS) */}
            <div
            ...
            {/* CWV LCP: H1 is the LCP element — render with zero animation delay, no transforms.
                style={{ opacity: 1, transform: 'none' }} ensures browser paints text immediately. */}
            <h1
              id="hero-heading"
            ...
            {/* Sub-headline — CWV CLS: Only animate opacity, NOT translate-y (prevents layout shift) */}
            <p
            ...
            {/* CTAs — CWV CLS: Only animate opacity, NOT translate-y */}
            <div
            ...
            {/* Supporting text — CWV CLS: Only animate opacity */}
            <p
            ...
            {/* Microcopy trust badges — CWV CLS: Only animate opacity */}
            <div
